...
To live up to the name of ``SmolPRNG`` there are less then 500 lines of code but implements over 16 different algorithms out of the box, with all features implmented I do not expect more then 1000 lines of code in total (fingers crossed).
